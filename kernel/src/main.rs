...
pub extern "C" fn KernelMain(frame_buffer_config: FrameBufferConfig) {
    ...
    let display = Display {
        ...
        frame_buffer_size: frame_buffer_config.frame_buffer_size,
    ...
    for i in 0..frame_buffer_config.horizontal_resolution {
        for j in 0..frame_buffer_config.vertical_resolution {
            // PixelColorにnewメソッドを生やす形だと動かない。なぜ？
            display.write_pixel(i as isize, j as isize, PixelColor{
                r: 255,
                g: 255,
                b: 255,
            });
    ...
    for i in 0..200 {
        for j in 0..100 {
            display.write_pixel(i, j, PixelColor{
                r: 0,
                g: 255,
                b: 0,
            });
